...
```
This plot showed the relationship between asthma and tree. Visually, there was a positive association between tree density and astham rate.
...
Visually, there was a positive association between astham rate and so2 and there was a postive association between astham rate and poverty level.
...
ggplot(final_asthma_df) +
  ...
  coord_flip()
```
Plot showed that children from 0 to 4 years have higher asthma rate compared to children from 5 to 14 years old.
