...
asthma_air = read_csv("./data/asthma_pollutes_poverty.csv") %>%
  janitor::clean_names()
...
poverty = read_csv("./data/asthma_pollutes_poverty.csv") %>%
  janitor::clean_names() %>%
...
poverty_under5 = read_csv("./data/asthma_pollutes_poverty.csv") %>%
  janitor::clean_names() %>%
  filter(year_description == "2011-15",
         measure == "Percent",
