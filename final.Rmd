...
```{r }
#among 652,173 trees, only 361 trees have diameter larger than 70, so we make plots without them.
...
```{r }
ggplot(final_df) +
  geom_boxplot(aes(x = boroname, y = sulfur_dioxide_so2, fill = boroname)) +
  theme(legend.position = "none")

ggplot(final_df) +
  geom_boxplot(aes(x = boroname, y = ozone_o3, fill = boroname)) +
  theme(legend.position = "none")

ggplot(final_df) +
  geom_boxplot(aes(x = boroname, y = nitric_oxide_no, fill = boroname)) +
  theme(legend.position = "none")

ggplot(final_df) +
  geom_boxplot(aes(x = boroname, y = nitrogen_dioxide_no2, fill = boroname)) +
  theme(legend.position = "none")

ggplot(final_df) +
  geom_boxplot(aes(x = boroname, y = black_carbon, fill = boroname)) +
  theme(legend.position = "none")

ggplot(final_df) +
  geom_boxplot(aes(x = boroname, y = fine_particulate_matter_pm2_5, fill = boroname)) +
  theme(legend.position = "none")
```
